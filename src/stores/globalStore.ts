...
<p>Option 3 : Si le ou les œuvres ne sont pas produites par l’artiste, le coût de production n'entre pas dans le calcul des honoraires de l’artiste et n'apparaît donc pas dans ce calculateur.</p>
...
help:`<p>Les textes commandés par la structure à l’artiste sont rémunérés pas 1000 frappes (espaces compris). Le coût forfaitaire par 1000 frappes est calculé automatiquement selon la taille de la structure d’accueil. La longueur du texte final est arrondi au millier de frappes le plus proche.</p>
<ul>Exemples : 
